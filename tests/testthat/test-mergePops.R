...
test_that("mergeMultiPops_and_flattenMultiPop", {
  ...
  expect_identical(flattenMultiPop(mp1)@pops[[1]], pop[1:5])
  expect_identical(flattenMultiPop(mp1)@pops[[2]], pop[6:10])
  expect_identical(flattenMultiPop(mp1, level = 2)@pops[[1]], pop[1:5])
  expect_identical(flattenMultiPop(mp1, level = 2)@pops[[2]], pop[6:10])
  expect_identical(flattenMultiPop(mp1, level = 3), mp1)
  ...
  expect_equal(flattenMultiPop(mp2, level = 2)@pops[[1]], pop[1:20])
  expect_equal(flattenMultiPop(mp2, level = 2)@pops[[2]], pop[21:40])
  expect_equal(flattenMultiPop(mp2, level = 2)@pops[[3]], 
  ...
  expect_identical(flattenMultiPop(mp3, level = 2)@pops[[1]], pop[1:20])
  expect_identical(flattenMultiPop(mp3, level = 2)@pops[[2]], 
                   newMultiPop(pop[21:30], pop[31:35], pop[36:40]))
  expect_identical(flattenMultiPop(mp3, level = 2)@pops[[3]], 
                   newMultiPop(pop[41:60], pop[61:80], pop[81:100]))
