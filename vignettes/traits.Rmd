...
There are two types of scaled genotype dosages in AlphaSimR: additive and dominance. An explanation for both is given below. This is followed by a table providing an example of dossage scaling in both diploid and autotetraploid organisms.
