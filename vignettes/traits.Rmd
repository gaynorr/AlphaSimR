...
This vignette describes the biological model for traits used in AlphaSimR. The biological model is responsible for converting an individual's genotype into a genetic value which is in turn used to create a phenotype. AlphaSimR's biological model is based primarily on classic models used in quantitative genetics. This means that most elements of the model should be familiar to anyone whose taken an introductory course in quantitative genetics. This vignette will assume the reader is such a person and thus focus on aspects of AlphaSimR's biological model that may not be obvious or don't follow a classic model. The vignette will begin by describing a novel classification system used in AlphaSimR to name different types of traits. Then it will present the full biological model along with a detailed description for each component in the model.
