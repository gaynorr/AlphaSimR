...
The function for genotype-by-environment effects is given above in equation (9). Unlike the previously discussed effects, this function does not from a classic quantitative genetics model. 
