...
In this section I provide a small example of AlphaSimR in action. The example is based on the "historical breeding" portion of the simulation performed in Jenko et al. [-@Jenko15]. This simulation is meant
...
# Each individuals has 10 chromosomes, each with 1000 segregating sites
