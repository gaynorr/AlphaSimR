...
gegvRRD <- function(RRsol, pop, nThreads) {
    .Call(`_AlphaSimR_gegvRRD`, RRsol, pop, nThreads)
}

gebvGCA <- function(sol, pop, female, nThreads) {
    .Call(`_AlphaSimR_gebvGCA`, sol, pop, female, nThreads)
}

gegvGCA <- function(sol, pop, nThreads) {
    .Call(`_AlphaSimR_gegvGCA`, sol, pop, nThreads)
}

gegvSCA <- function(sol, pop, nThreads) {
...
callRRBLUP_GCA2 <- function(y, x, reps, geno, lociPerChr, lociLoc, maxIter, Vu1, Vu2, Ve, tol, useEM) {
    .Call(`_AlphaSimR_callRRBLUP_GCA2`, y, x, reps, geno, lociPerChr, lociLoc, maxIter, Vu1, Vu2, Ve, tol, useEM)
}
...
getGenoT <- function(geno, lociPerChr, lociLoc) {
    .Call(`_AlphaSimR_getGenoT`, geno, lociPerChr, lociLoc)
}
...
getOneHaploT <- function(geno, lociPerChr, lociLoc, haplo) {
    .Call(`_AlphaSimR_getOneHaploT`, geno, lociPerChr, lociLoc, haplo)
}
