...
#' each population.
#'
#' @param x An object of class \code{\link{Pop-class}},
#'   \code{\link{HybridPop-class}} or \code{\link{MultiPop-class}}.
#' @param FUN A function that accepts the individual-phenotype matrix
#'   from a population (e.g. \code{x@pheno} or \code{x@pops[[1]]@pheno}) as its first argument and returns 
...
#'   \code{x@miscPop$pheno} or  \code{x@pops[...]@miscPop$pheno} slot updated.
...
#' @export
setPhenoPop = function(pop, FUN=colMeans, force=FALSE, traits=NULL, fixEff=1L, 
